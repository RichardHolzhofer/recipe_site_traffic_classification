...
from recipesitetraffic.utils.cloud import S3Sync
from recipesitetraffic.constants.constants import TRAINING_PIPELINE_ARTIFACT_BUCKET_NAME
...
from recipesitetraffic.entity.artifact_entity import (
...
class TrainingPipeline:
    ...
    def start_model_trainer(self, data_validation_artifact: DataValidationArtifact, data_transformation_artifact:DataTransformationArtifact):
        try:
    ...
    def sync_artifact_dir_to_s3(self):
        try:
            aws_bucket_url = f"s3://{TRAINING_PIPELINE_ARTIFACT_BUCKET_NAME}/artifact/{self.training_pipeline_config.timestamp}"
    ...
    def sync_saved_model_dir_to_s3(self):
        try:
            aws_bucket_url = f"s3://{TRAINING_PIPELINE_ARTIFACT_BUCKET_NAME}/final_model/{self.training_pipeline_config.timestamp}"
